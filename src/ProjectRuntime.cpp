...
ProjectProfile demoProfile() {
  return ProjectProfile{
      ...
      MetricSpec{"boot_time_s", "s", 8.0, true},
      MetricSpec{"rootfs_size_mb", "MB", 96.0, true},
      false};
}

RuntimeSample nominalSample() {
  return RuntimeSample{1U, 3.6, 43.2, true, "host-ci-nominal"};
}

RuntimeSample unsafeSample() {
  return RuntimeSample{2U, 10.8, 129.6, true, "host-ci-limit-test"};
}

RuntimeSample offlineSample() {
  return RuntimeSample{3U, 3.6, 43.2, false, "host-ci-offline"};
}
